...
public class FaceSpell {
    ...
    private static final Identifier[] TEXTURES = new Identifier[]{FaceTexture.SPELL_RED, FaceTexture.SPELL_YELLOW, FaceTexture.SPELL_BLUE, FaceTexture.SPELL_BLUE};
    ...
    public void update(DrawContext context, ItemStack stack, int x, int y) {
        ...
        if (this.maxCharges > 1 && INSTANCE.CONFIG.inventory.hotbar.useCustom) {
    ...
    private void drawCooldown(DrawContext context, int x, int y) {
        ...
        int size = INSTANCE.CONFIG.inventory.hotbar.useCustom ? (int) getSize() : 16;
    ...
    public void animate(DrawContext context, ItemStack stack) {
        ...
        if (onCooldown) {
            ...
            if (!INSTANCE.CONFIG.inventory.hotbar.useCustom)
